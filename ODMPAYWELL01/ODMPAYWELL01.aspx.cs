...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMPAYWELL01 的摘要描述。
	/// </summary>
	public partial class ODMPAYWELL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMPAYWELL01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMPAYWELL01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "username", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "money01", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "mtotal", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "inv01", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "inv02", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "other", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "empl2", tLanguageType);
			this.chkkind01.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkkind01", tLanguageType);
			this.chkkind02.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkkind02", tLanguageType);
			this.chkkind03.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkkind03", tLanguageType);
			this.chkkind04.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkkind04", tLanguageType);
			this.chkkind05.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkkind05", tLanguageType);
			this.selcurr01.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "selcurr01", tLanguageType);
			this.selcurr06.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "selcurr06", tLanguageType);
			this.chkadd01.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkadd01", tLanguageType);
			this.chkadd02.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkadd02", tLanguageType);
			this.chkadd03.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkadd03", tLanguageType);
			this.chkadd04.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkadd04", tLanguageType);
			this.chkadd05.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkadd05", tLanguageType);
			this.chkadd06.Text = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "chkadd06", tLanguageType);
			this.txtassno.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "txtassno", tLanguageType);
			this.queryfirm.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "queryfirm", tLanguageType);
			this.txtother.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "txtother", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "textarea2", tLanguageType);
			this.selcurr02.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "selcurr02", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMPAYWELL01", "money02", tLanguageType);
...
this.chkadd03.Text = String.Empty;
this.chkadd04.Text = String.Empty;
this.chkadd05.Text = String.Empty;
this.chkadd06.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMPAYWELL01";
			// 表單代號
			this.formID = "ODMPAYWELL01";
...
this.chkadd03.Attributes.Add("onclick", " if($('#MasterPage_MasterPageContent_chkadd03_chk')[0].checked){{$('#MasterPage_MasterPageContent_orderno').show();}} else{{$('#MasterPage_MasterPageContent_orderno').hide();}} ");
this.chkadd06.Attributes.Add("onclick", " if($('#MasterPage_MasterPageContent_chkadd06_chk')[0].checked){{$('#MasterPage_MasterPageContent_txtassno').show();}} else{{$('#MasterPage_MasterPageContent_txtassno').hide();}} ");
...
this.kind_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_kind_txt').value = '1';");
		...
		protected override void SetDefaultValue(Hashtable defalutHash)
		{
			...
			defalutHash.Add("odmpaywell01001", this.formID);
			defalutHash.Add("odmpaywell01002", this.SheetNo);
			...
			defalutHash.Add("selcurr01", "USD");
			defalutHash.Add("selcurr02", "USD");
			defalutHash.Add("selcurr06", "USD");
...
order by resdd003 desc";
		...
		{
			pReport = "ODMPAYWELL01";
			pReportID = "ODMPAYWELL01_02";//憑證式
			pWhere = "AND (odmpaywell01001='" + this.formID + "') AND (odmpaywell01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMPAYWELL01";
