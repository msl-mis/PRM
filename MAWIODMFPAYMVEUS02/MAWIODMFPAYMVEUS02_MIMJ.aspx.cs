...
{
	/// <summary>
	/// ODMFPAYMVEUS02_MIMJ 的摘要描述。
	/// </summary>
	public partial class MAWIODMFPAYMVEUS02_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MJFunction()
		{
			...
			{
				case "OpenMIMJ01_24_opentype01":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","24",1,FinalList, @"192.168.10.22", "price","opentype01_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["openitem01_txt"] != null && tAllInputValues["openitem01_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","07",aryParamger,FinalList, @"192.168.10.22", "price","openitem01_txt2=item_name");
							if(!bTriggerMJ){
				...
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","24",1,FinalList, @"192.168.10.22", "price","opentype02_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["openitem02_txt"] != null && tAllInputValues["openitem02_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","07",aryParamger,FinalList, @"192.168.10.22", "price","openitem02_txt2=item_name");
							if(!bTriggerMJ){
				...
				{
					base.doMJByDB("TrigMIMJ01","07", @"192.168.10.22", "price","openitem01_txt2=item_name");
					break;
				}
				case "OpenMIMJ01_24_opentype03":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","24",1,FinalList, @"192.168.10.22", "price","opentype03_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["openitem03_txt"] != null && tAllInputValues["openitem03_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","07",aryParamger,FinalList, @"192.168.10.22", "price","openitem03_txt2=item_name");
							if(!bTriggerMJ){
				...
				{
					base.doMJByDB("TrigMIMJ01","07", @"192.168.10.22", "price","openitem02_txt2=item_name");
					break;
				}
				case "TrigMIMJ01_07_openitem03":	
				{
					base.doMJByDB("TrigMIMJ01","07", @"192.168.10.22", "price","openitem03_txt2=item_name");
					break;
				}
				case "員工代號_SenderID":	
				{
