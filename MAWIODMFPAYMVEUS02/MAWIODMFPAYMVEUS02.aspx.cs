...
{
	/// <summary>
	/// MAWIODMFPAYMVEUS02 的摘要描述。
	/// </summary>
	public partial class MAWIODMFPAYMVEUS02 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFProgramBasePage
	{
		...
		{
			AjaxPro.Utility.RegisterTypeForAjax(typeof(MAWIODMFPAYMVEUS02));
			//隱藏span
			...
			this.TabStrip1.Items[0].Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYMVEUS02", "TabStrip1", tLanguageType);
			this.lblTitle.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYMVEUS02", "lblTitle", tLanguageType);

			//頁籤的多國語系
						string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYMVEUS02", "HeadTabStrip01", tLanguageType);
			...
			//程式title
			string tProgramTitle = MultiLanguage.GetComment("FD", "MAWIODMFPAYMVEUS02", "lblTitle", tLanguageType);
			LiteralTitle.Text = tProgramTitle;

			//多國語系
			
			this.lblcn.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYMVEUS02", "lblcn", tLanguageType);
			this.lblvn.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYMVEUS02", "lblvn", tLanguageType);
			this.lblyear.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYMVEUS02", "lblyear", tLanguageType);
...
this.chkitem05.Text = String.Empty;
		...
		protected override void settingHeaderShown()
		{
			...
			GridUserControl0.ShowColumns("odmfpaymveus02001");
			GridUserControl0.ShowColumns("odmfpaymveus02002");
			...
			GridUserControl0.ShowColumns("chpay", gridUserControl.GridColumnType.DropDownList,"0=" + MultiLanguage.GetComment("FD", "ODMFPAYMVEUS02", "chpay_0", UserInfo.Language) + "§" + "1=" + MultiLanguage.GetComment("FD", "ODMFPAYMVEUS02", "chpay_1", UserInfo.Language) + "§" + "2=" + MultiLanguage.GetComment("FD", "ODMFPAYMVEUS02", "chpay_2", UserInfo.Language));
			...
			GridUserControl0.ShowColumns("curr", gridUserControl.GridColumnType.DropDownList,"USD=" + MultiLanguage.GetComment("Combo", "ODMFPAYMVEUS02_curr", "USD", UserInfo.Language));
			GridUserControl0.ShowColumns("useyear");
			GridUserControl0.ShowColumns("chkven", gridUserControl.GridColumnType.DropDownList,"0=" + MultiLanguage.GetComment("FD", "ODMFPAYMVEUS02", "chkven_0", UserInfo.Language) + "§" + "1=" + MultiLanguage.GetComment("FD", "ODMFPAYMVEUS02", "chkven_1", UserInfo.Language));
		...
		protected override void settingQBEAdvancedElement()
		{
			...
			base.CusQBEAdvancedElements.Add("odmfpaymveus02001");
			base.CusQBEAdvancedElements.Add("odmfpaymveus02002");
		...
		{
			//這個作業的BOID
			HeadBOID = "MAWIODMFPAYMVEUS02";
			//作業代號
			TaskId = "MAWIODMFPAYMVEUS02";
		...
		protected override void settingClientFunction()
		{
            ...
            //opentype01.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype01_txt","OpenMIMJ01_24_opentype01","opentype01_txt,openitem01_txt")+";InitTriggerOpen();");
            opentype01.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("opentype01_txt", "OpenMIMJ01_24_opentype01", "opentype01_txt,openitem01_txt") + ";InitTriggerOpen();opentype_change();");
            ...
            openitem01.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("openitem01_txt", "TrigMIMJ01_07_openitem01", "openitem01_txt,opentype01_txt"));
            ...
            //20230424 edit by Peggy S
            //opentype02.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype02_txt","OpenMIMJ01_24_opentype02","opentype02_txt,openitem02_txt")+";InitTriggerOpen();");
            opentype02.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("opentype02_txt", "OpenMIMJ01_24_opentype02", "opentype02_txt,openitem02_txt") + ";InitTriggerOpen();opentype_change();");
            //20230424 edit by Peggy E
            ...
            openitem02.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("openitem02_txt", "TrigMIMJ01_07_openitem02", "openitem02_txt,opentype02_txt"));
            ...
            //20230424 edit by Peggy S
            //opentype03.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype03_txt","OpenMIMJ01_24_opentype03","opentype03_txt,openitem03_txt")+";InitTriggerOpen();");
            opentype03.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("opentype03_txt", "OpenMIMJ01_24_opentype03", "opentype03_txt,openitem03_txt") + ";InitTriggerOpen();opentype_change();");
            ...
            openitem03.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("openitem03_txt", "TrigMIMJ01_07_openitem03", "openitem03_txt,opentype03_txt"));
