...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// </summary>
	public partial class MAWIODMFPAYCNT02_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				...
				case "SenderID_btn":			//員工代號
				{
					base.doMI("RESAK","03");
					break;
				}
				case "SuperID_btn":			//員工代號
				{
					base.doMI("RESAK","03");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			switch(tMJ)//欄位ID命名要規則化
			{
				...
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","23",1,FinalList, @"192.168.10.22", "price","opentype01_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["openitem01_txt"] != null && tAllInputValues["openitem01_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","08",aryParamger,FinalList, @"192.168.10.22", "price","openitem01_txt2=item_name");
							if(!bTriggerMJ){
				...
				{
					base.doMJByDB("TrigMIMJ01","08", @"192.168.10.22", "price","openitem01_txt2=item_name");
					break;
				}
				case "OpenMIMJ01_23_opentype02":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","23",1,FinalList, @"192.168.10.22", "price","opentype02_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["openitem02_txt"] != null && tAllInputValues["openitem02_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","08",aryParamger,FinalList, @"192.168.10.22", "price","openitem02_txt2=item_name");
							if(!bTriggerMJ){
				...
				{
					base.doMJByDB("TrigMIMJ01","08", @"192.168.10.22", "price","openitem02_txt2=item_name");
					break;
				}
				case "OpenMIMJ01_23_opentype03":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","23",1,FinalList, @"192.168.10.22", "price","opentype03_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["openitem03_txt"] != null && tAllInputValues["openitem03_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","08",aryParamger,FinalList, @"192.168.10.22", "price","openitem03_txt2=item_name");
							if(!bTriggerMJ){
				...
				{
					base.doMJByDB("TrigMIMJ01","08", @"192.168.10.22", "price","openitem03_txt2=item_name");
					break;
				}
				case "OpenMIMJ01_23_opentype04":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","23",1,FinalList, @"192.168.10.22", "price","opentype04_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["openitem04_txt"] != null && tAllInputValues["openitem04_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","08",aryParamger,FinalList, @"192.168.10.22", "price","openitem04_txt2=item_name");
							if(!bTriggerMJ){
				...
				{
					base.doMJByDB("TrigMIMJ01","08", @"192.168.10.22", "price","openitem04_txt2=item_name");
					break;
				}
				case "OpenMIMJ01_23_opentype05":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","23",1,FinalList, @"192.168.10.22", "price","opentype05_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["openitem05_txt"] != null && tAllInputValues["openitem05_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","08",aryParamger,FinalList, @"192.168.10.22", "price","openitem05_txt2=item_name");
							if(!bTriggerMJ){
				...
				{
					base.doMJByDB("TrigMIMJ01","08", @"192.168.10.22", "price","openitem05_txt2=item_name");
					break;
				}
				case "員工代號_SenderID":	
				{
					base.doMJ("RESAK","03","SenderID_txt2=resak002");
					break;
				}
				case "員工代號_SuperID":	
				{
					base.doMJ("RESAK","03","SuperID_txt2=resak002");
					break;
				}
