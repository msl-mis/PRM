...
{
	/// <summary>
	/// MAWIODMFPAYCNT02 的摘要描述。
	/// </summary>
	public partial class MAWIODMFPAYCNT02 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFProgramBasePage
	{
		...
		{
			AjaxPro.Utility.RegisterTypeForAjax(typeof(MAWIODMFPAYCNT02));
			//隱藏span
			...
			this.TabStrip1.Items[0].Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCNT02", "TabStrip1", tLanguageType);
			this.lblTitle.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCNT02", "lblTitle", tLanguageType);

			//頁籤的多國語系
						string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCNT02", "HeadTabStrip01", tLanguageType);
			...
			//程式title
			string tProgramTitle = MultiLanguage.GetComment("FD", "MAWIODMFPAYCNT02", "lblTitle", tLanguageType);
			LiteralTitle.Text = tProgramTitle;

			//多國語系
			
			this.lblcn.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCNT02", "lblcn", tLanguageType);
			this.lblvn.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCNT02", "lblvn", tLanguageType);
...
this.other.Text = String.Empty;
			...
			/*Grid0 Setting Start*/
			SenderID.Attributes.Add("style", "display:none;");
			SuperID.Attributes.Add("style", "display:none;");

		if(listGrid0HeaderString.Contains("SenderID"))
			listGrid0HeaderString.Remove("SenderID");
		if(listGrid0HeaderString.Contains("SuperID"))
			listGrid0HeaderString.Remove("SuperID");

		if (GridUserControl0.HeaderShown.Contains("SenderID"))
			GridUserControl0.HeaderShown.Remove("SenderID");
		if (GridUserControl0.HeaderShown.Contains("SuperID"))
			GridUserControl0.HeaderShown.Remove("SuperID");
			/*Grid0 Setting End*/
		...
		protected override void settingHeaderShown()
		{
			...
			GridUserControl0.ShowColumns("odmfpaycnt02001");
			GridUserControl0.ShowColumns("odmfpaycnt02002");
			GridUserControl0.ShowColumns("kind", gridUserControl.GridColumnType.DropDownList,"0=" + MultiLanguage.GetComment("FD", "ODMFPAYCNT02", "kind_0", UserInfo.Language) + "§" + "1=" + MultiLanguage.GetComment("FD", "ODMFPAYCNT02", "kind_1", UserInfo.Language));
			...
			GridUserControl0.ShowColumns("chpay", gridUserControl.GridColumnType.DropDownList,"0=" + MultiLanguage.GetComment("FD", "ODMFPAYCNT02", "chpay_0", UserInfo.Language) + "§" + "1=" + MultiLanguage.GetComment("FD", "ODMFPAYCNT02", "chpay_1", UserInfo.Language) + "§" + "2=" + MultiLanguage.GetComment("FD", "ODMFPAYCNT02", "chpay_2", UserInfo.Language));
			...
			GridUserControl0.ShowColumns("SenderID");
			GridUserControl0.ShowColumns("SenderIDC");
			GridUserControl0.ShowColumns("chkatt05", gridUserControl.GridColumnType.DropDownList,"1=Y§0=N");
			GridUserControl0.ShowColumns("SuperID");
			GridUserControl0.ShowColumns("SuperIDC");
			...
			GridUserControl0.ShowColumns("curr", gridUserControl.GridColumnType.DropDownList,"RMB=" + MultiLanguage.GetComment("Combo", "ODMFPAYCNT02_curr", "RMB", UserInfo.Language) + "§" +"NTD=" + MultiLanguage.GetComment("Combo", "ODMFPAYCNT02_curr", "NTD", UserInfo.Language) + "§" +"USD=" + MultiLanguage.GetComment("Combo", "ODMFPAYCNT02_curr", "USD", UserInfo.Language));
			GridUserControl0.ShowColumns("useyear");
			GridUserControl0.ShowColumns("chkven", gridUserControl.GridColumnType.DropDownList,"0=" + MultiLanguage.GetComment("FD", "ODMFPAYCNT02", "chkven_0", UserInfo.Language) + "§" + "1=" + MultiLanguage.GetComment("FD", "ODMFPAYCNT02", "chkven_1", UserInfo.Language));
		...
		protected override void settingQBEAdvancedElement()
		{
			...
			base.CusQBEAdvancedElements.Add("odmfpaycnt02001");
			base.CusQBEAdvancedElements.Add("odmfpaycnt02002");
			...
			base.CusQBEAdvancedElements.Add("SenderIDC");
			base.CusQBEAdvancedElements.Add("chkatt05");
			base.CusQBEAdvancedElements.Add("SuperIDC");
		...
		{
			//這個作業的BOID
			HeadBOID = "MAWIODMFPAYCNT02";
			//作業代號
			TaskId = "MAWIODMFPAYCNT02";
		...
		protected override void settingClientFunction()
		{
            ...
            //opentype01.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype01_txt","OpenMIMJ01_23_opentype01","opentype01_txt,openitem01_txt")+";InitTriggerOpen();");
            opentype01.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("opentype01_txt", "OpenMIMJ01_23_opentype01", "opentype01_txt,openitem01_txt") + ";InitTriggerOpen();opentype_change();");
            ...
            openitem01.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("openitem01_txt", "TrigMIMJ01_08_openitem01", "openitem01_txt,opentype01_txt"));
            ...
            //20230424 edit by Peggy S
            //opentype02.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype02_txt","OpenMIMJ01_23_opentype02","opentype02_txt,openitem02_txt")+";InitTriggerOpen();");
            opentype02.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("opentype02_txt", "OpenMIMJ01_23_opentype02", "opentype02_txt,openitem02_txt") + ";InitTriggerOpen();opentype_change();");
            //20230424 edit by Peggy E
            ...
            openitem02.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("openitem02_txt", "TrigMIMJ01_08_openitem02", "openitem02_txt,opentype02_txt"));
            ...
            //20230424 edit by Peggy S
            //opentype03.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype03_txt","OpenMIMJ01_23_opentype03","opentype03_txt,openitem03_txt")+";InitTriggerOpen();");
            opentype03.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("opentype03_txt", "OpenMIMJ01_23_opentype03", "opentype03_txt,openitem03_txt") + ";InitTriggerOpen();opentype_change();");
            ...
            openitem03.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("openitem03_txt", "TrigMIMJ01_08_openitem03", "openitem03_txt,opentype03_txt"));
            ...
            //20230424 edit by Peggy S
            //opentype04.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype04_txt","OpenMIMJ01_23_opentype04","opentype04_txt,openitem04_txt")+";InitTriggerOpen();");
            opentype04.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("opentype04_txt", "OpenMIMJ01_23_opentype04", "opentype04_txt,openitem04_txt") + ";InitTriggerOpen();opentype_change();");
            ...
            openitem04.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("openitem04_txt", "TrigMIMJ01_08_openitem04", "openitem04_txt,opentype04_txt"));
            ...
            //20230424 edit by Peggy S
            //opentype05.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype05_txt","OpenMIMJ01_23_opentype05","opentype05_txt,openitem05_txt")+";InitTriggerOpen();");
            opentype05.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("opentype05_txt", "OpenMIMJ01_23_opentype05", "opentype05_txt,openitem05_txt") + ";InitTriggerOpen();opentype_change();");
            ...
            openitem05.TxtInput.Attributes.Add("onblur", MIMJUtil.getBlurParams("openitem05_txt", "TrigMIMJ01_08_openitem05", "openitem05_txt,opentype05_txt"));
            ...
            switch (tWindowOpenStyle){
				case "2":
					...
					break;
				default:
					SenderID.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams("SenderID_btn","SenderID_txt","S"));
					break;
			}
			SenderID.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("SenderID_txt","員工代號_SenderID","SenderID_txt"));
			SenderID.TxtInput.Attributes.Add("onchange","AddtoHash('SenderID_txt');");
			...
			switch (tWindowOpenStyle){
				case "2":
					...
					break;
				default:
					SuperID.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams("SuperID_btn","SuperID_txt","S"));
					break;
			}
			SuperID.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("SuperID_txt","員工代號_SuperID","SuperID_txt"));
			SuperID.TxtInput.Attributes.Add("onchange","AddtoHash('SuperID_txt');");
            ...
            //this.chkitem02.Attributes.Add("onclick", " if($('#chkitem02_chk')[0].checked){{$('#itemname').show();}} else{{$('#itemname').hide();}} ");
