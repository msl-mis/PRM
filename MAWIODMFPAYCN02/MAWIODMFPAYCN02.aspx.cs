...
{
	/// <summary>
	/// MAWIODMFPAYCN02 的摘要描述。
	/// </summary>
	public partial class MAWIODMFPAYCN02 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFProgramBasePage
	{
		...
		{
			AjaxPro.Utility.RegisterTypeForAjax(typeof(MAWIODMFPAYCN02));
			//隱藏span
			...
			this.TabStrip1.Items[0].Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCN02", "TabStrip1", tLanguageType);
			this.lblTitle.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCN02", "lblTitle", tLanguageType);

			//頁籤的多國語系
						string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCN02", "HeadTabStrip01", tLanguageType);
			...
			//程式title
			string tProgramTitle = MultiLanguage.GetComment("FD", "MAWIODMFPAYCN02", "lblTitle", tLanguageType);
			LiteralTitle.Text = tProgramTitle;

			//多國語系
			
			this.lblcn.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCN02", "lblcn", tLanguageType);
			this.lblvn.Text = MultiLanguage.GetComment("FD", "MAWIODMFPAYCN02", "lblvn", tLanguageType);
...
this.other.Text = String.Empty;
		...
		protected override void settingHeaderShown()
		{
			...
			GridUserControl0.ShowColumns("odmfpaycn02001");
			GridUserControl0.ShowColumns("odmfpaycn02002");
			GridUserControl0.ShowColumns("kind", gridUserControl.GridColumnType.DropDownList,"0=" + MultiLanguage.GetComment("FD", "ODMFPAYCN02", "kind_0", UserInfo.Language) + "§" + "1=" + MultiLanguage.GetComment("FD", "ODMFPAYCN02", "kind_1", UserInfo.Language) + "§" + "2=" + MultiLanguage.GetComment("FD", "ODMFPAYCN02", "kind_2", UserInfo.Language));
			...
			GridUserControl0.ShowColumns("chpay", gridUserControl.GridColumnType.DropDownList,"0=" + MultiLanguage.GetComment("FD", "ODMFPAYCN02", "chpay_0", UserInfo.Language) + "§" + "1=" + MultiLanguage.GetComment("FD", "ODMFPAYCN02", "chpay_1", UserInfo.Language) + "§" + "2=" + MultiLanguage.GetComment("FD", "ODMFPAYCN02", "chpay_2", UserInfo.Language));
			...
			GridUserControl0.ShowColumns("curr", gridUserControl.GridColumnType.DropDownList,"RMB=" + MultiLanguage.GetComment("Combo", "ODMFPAYCN02_curr", "RMB", UserInfo.Language) + "§" +"NTD=" + MultiLanguage.GetComment("Combo", "ODMFPAYCN02_curr", "NTD", UserInfo.Language) + "§" +"USD=" + MultiLanguage.GetComment("Combo", "ODMFPAYCN02_curr", "USD", UserInfo.Language));
			GridUserControl0.ShowColumns("curr06");
			GridUserControl0.ShowColumns("itemname");
			GridUserControl0.ShowColumns("useyear");
			GridUserControl0.ShowColumns("chkven", gridUserControl.GridColumnType.DropDownList,"0=" + MultiLanguage.GetComment("FD", "ODMFPAYCN02", "chkven_0", UserInfo.Language) + "§" + "1=" + MultiLanguage.GetComment("FD", "ODMFPAYCN02", "chkven_1", UserInfo.Language));
		...
		protected override void settingQBEAdvancedElement()
		{
			...
			base.CusQBEAdvancedElements.Add("odmfpaycn02001");
			base.CusQBEAdvancedElements.Add("odmfpaycn02002");
			...
			base.CusQBEAdvancedElements.Add("curr06");
			base.CusQBEAdvancedElements.Add("itemname");
		...
		{
			//這個作業的BOID
			HeadBOID = "MAWIODMFPAYCN02";
			//作業代號
			TaskId = "MAWIODMFPAYCN02";
		...
		protected override void settingClientFunction()
		{
            ...
            //opentype01.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype01_txt","OpenMIMJ01_20_opentype01","opentype01_txt,openitem01_txt")+";InitTriggerOpen();");
            ...
            //20230424 edit by Peggy S
            //opentype02.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype02_txt","OpenMIMJ01_20_opentype02","opentype02_txt,openitem02_txt")+";InitTriggerOpen();");
            ...
            //20230424 edit by Peggy S
            //opentype03.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype03_txt","OpenMIMJ01_20_opentype03","opentype03_txt,openitem03_txt")+";InitTriggerOpen();");
            ...
            //20230424 edit by Peggy S
            //opentype04.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype04_txt","OpenMIMJ01_20_opentype04","opentype04_txt,openitem04_txt")+";InitTriggerOpen();");
            ...
            //20230424 edit by Peggy S
            //opentype05.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("opentype05_txt","OpenMIMJ01_20_opentype05","opentype05_txt,openitem05_txt")+";InitTriggerOpen();");
